...
[Demo Blog](https://judy-kimsohui.vercel.app) | [Demo Resume](https://judy-kimsohui.vercel.app/resume)
...
1. Star this repo.
2. [Fork](https://github.com/morethanmin/judy-kimsohui/fork) the repo to your Profile.
...
## 10 Steps to build your own judy-kimsohui (by 23.06.23)
...
<details>
   ...
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/b0421776-2bfe-42bc-ae31-d90206fd5789' width = '500'>
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/185a8e4c-4ae2-4a38-b6f4-dc2a06a45c28' width = '500'>
   ...
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/a5375429-28f0-4bba-a355-0d391cad58db' width = '500'>

   3. And you will see `notion page in notion app` in your account.
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/09af5533-43d9-48e5-95eb-dcac84c97c1f' width = '500'>

   4. Click `Share` and `Publish` in right top, and check web link. (Copy web link)
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/886fe4a2-79ca-4dbc-b1e1-93984e7e3f44' width = '500'>
   
   5. `Modify` **site.config.js** file in **your** forked repo.
   > 💡 NOTE. I changed **2 RED PART**
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/3d9c0da5-92bc-4372-8752-7bfc810b4986' width = '500'>

   6. Move and `login` to vercel.
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/07742ad0-4766-43b0-9ebd-5311f9711bc2' width = '500'>

   7. `Build` new project using **Add New...**
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/517d46be-c9bf-4181-aaa5-e9bd2fcdc822' width = '500'>

   8. `Import` **your forked judy-kimsohui repository**
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/07742ad0-4766-43b0-9ebd-5311f9711bc2' width = '500'>

   9. `Add` **Environment variabes** to vercel project
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/703b50a3-3a90-4915-ab73-1baca4c285f8' width = '500'>

   10. `Wait` for the deployment to complete. After the deployment is successful, you should see an image like the one below.
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/a7d72caa-4354-4f81-9577-c773faeed7c6' width = '500'>

   🥳 Congratulations. Now check out your blog
   
   <img src='https://github.com/jhk0530/judy-kimsohui/assets/6457691/3876a273-a270-47ef-a2ad-663519d9e537' width = '500'>
...
<details>
   ...
   A4: You can check https://github.com/morethanmin/judy-kimsohui/issues/203. Please note that updates may take some time to take effect after setting.
...
<a href="https://github.com/morethanmin/judy-kimsohui/graphs/contributors">
<img src="https://contrib.rocks/image?repo=morethanmin/judy-kimsohui" />
</a>

## Support

judy-kimsohui is an MIT-licensed open source project. It can grow thanks to the sponsors and support from the amazing backers.
